/*
 * Copyright (c) 2019, 2022, 2025 Oracle and/or its affiliates.
 *
...
public class WeldSubstitutions {
    ...
    static final class ContainerLifecycleEventPreloaderSubstitution {
        ...
        void preloadContainerLifecycleEvent(Class<?> eventRawType, Type... typeParameters) {
            dtf.newThread((Runnable) () -> notifier.resolveObserverMethods(new ParameterizedTypeImpl(eventRawType, typeParameters, null))).start();
        }
